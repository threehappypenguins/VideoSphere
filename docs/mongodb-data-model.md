...
| `live_translation_channels` | `LiveTranslationChannel` | Per-user live audio translation credentials, languages, public slug, stream key hash |
...
Connected account tokens, SFTP credentials, SMB credentials, SermonAudio API keys, and live-translation OpenRouter / Groq / GCP service-account secrets are encrypted before persistence.
