...
/**
 * Admin invite management page for generating and revoking invite links.
      ...
      <div className="mx-auto max-w-5xl">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Generate single-use links to invite friends. Public signup is disabled.
          </p>
        </div>
            ...
            <tbody>
              {loading ? (
                ...
                invites.map((invite) => {
                  ...
                  return (
                    <tr key={invite.token} className="border-b border-border">
