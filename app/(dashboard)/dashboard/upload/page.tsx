  ...
  return (
    <div className="px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="rounded-xl border-2 border-dashed border-border bg-muted p-10 text-center">
          <p className="text-lg font-medium">Drag and drop upload area</p>
          <p className="mt-2 text-sm text-muted-foreground">
            Supported formats: MP4, MOV, AVI, WebM
          </p>
          <p className="text-sm text-muted-foreground">Maximum file size: up to 2 GB per video</p>
