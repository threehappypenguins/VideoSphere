...
/** Bible books with chapter and verse counts for the reference picker. */
export const SERMON_AUDIO_BIBLE_BOOKS: readonly SermonAudioBibleBook[] = [
  {
    displayName: 'Genesis',
    osisAbbrev: 'gn',
    chapters: [
  ...
  { displayName: 'Ruth', osisAbbrev: 'rt', chapters: [22, 23, 18, 22] as const },
  {
  ...
  },
  {
    displayName: 'Ezra',
    osisAbbrev: 'ezr',
    chapters: [11, 70, 13, 24, 17, 22, 28, 36, 15, 44] as const,
  },
  {
    displayName: 'Nehemiah',
    osisAbbrev: 'ne',
    chapters: [11, 20, 32, 23, 19, 19, 73, 18, 38, 39, 36, 47, 31] as const,
  },
  {
    displayName: 'Esther',
    osisAbbrev: 'et',
    chapters: [22, 23, 15, 17, 14, 14, 10, 17, 32, 3] as const,
  },
  {
    displayName: 'Job',
    osisAbbrev: 'job',
  ...
  },
  {
    ...
    osisAbbrev: 'ec',
    chapters: [18, 26, 22, 16, 20, 12, 29, 17, 18, 20, 10, 14] as const,
  },
  {
    displayName: 'Song of Solomon',
    osisAbbrev: 'so',
    chapters: [17, 17, 11, 16, 16, 13, 13, 14] as const,
  },
  {
    displayName: 'Isaiah',
    osisAbbrev: 'is',
  ...
  { displayName: 'Lamentations', osisAbbrev: 'lm', chapters: [22, 22, 66, 22, 22] as const },
  {
    displayName: 'Ezekiel',
    osisAbbrev: 'ez',
    chapters: [
  ...
  },
  {
    displayName: 'Daniel',
    osisAbbrev: 'dn',
    chapters: [21, 49, 30, 37, 31, 28, 28, 27, 27, 21, 45, 13] as const,
  },
  {
    displayName: 'Hosea',
    osisAbbrev: 'ho',
    chapters: [11, 23, 5, 19, 15, 11, 16, 14, 17, 15, 12, 14, 16, 9] as const,
  },
  { displayName: 'Joel', osisAbbrev: 'jl', chapters: [20, 32, 21] as const },
  {
    displayName: 'Amos',
    osisAbbrev: 'am',
    chapters: [15, 16, 15, 13, 27, 14, 17, 14, 15] as const,
  },
  { displayName: 'Obadiah', osisAbbrev: 'ob', chapters: [21] as const },
  { displayName: 'Jonah', osisAbbrev: 'jn', chapters: [17, 10, 10, 11] as const },
  { displayName: 'Micah', osisAbbrev: 'mi', chapters: [16, 13, 12, 13, 15, 16, 20] as const },
  { displayName: 'Nahum', osisAbbrev: 'na', chapters: [15, 13, 19] as const },
  { displayName: 'Habakkuk', osisAbbrev: 'hk', chapters: [17, 20, 19] as const },
  { displayName: 'Zephaniah', osisAbbrev: 'zp', chapters: [18, 15, 20] as const },
  { displayName: 'Haggai', osisAbbrev: 'hg', chapters: [15, 23] as const },
  {
    displayName: 'Zechariah',
    osisAbbrev: 'zc',
    chapters: [21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9, 21] as const,
  },
  { displayName: 'Malachi', osisAbbrev: 'ml', chapters: [14, 17, 18, 6] as const },
  {
    displayName: 'Matthew',
    osisAbbrev: 'mt',
    chapters: [
  ...
  },
  {
    displayName: 'Mark',
    osisAbbrev: 'mk',
    chapters: [45, 28, 35, 40, 43, 56, 36, 37, 50, 52, 33, 44, 37, 72, 47, 20] as const,
  },
  {
    displayName: 'Luke',
    osisAbbrev: 'lk',
  ...
  },
  {
    displayName: 'Romans',
    osisAbbrev: 'rm',
    chapters: [32, 29, 31, 25, 21, 23, 25, 39, 33, 21, 36, 21, 14, 23, 33, 27] as const,
  },
  {
    displayName: '1 Corinthians',
    osisAbbrev: '1co',
    chapters: [31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58, 24] as const,
  },
  {
    displayName: '2 Corinthians',
    osisAbbrev: '2co',
    chapters: [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14] as const,
  },
  { displayName: 'Galatians', osisAbbrev: 'gl', chapters: [24, 21, 29, 31, 26, 18] as const },
  { displayName: 'Ephesians', osisAbbrev: 'eph', chapters: [23, 22, 21, 32, 33, 24] as const },
  { displayName: 'Philippians', osisAbbrev: 'ph', chapters: [30, 30, 21, 23] as const },
  { displayName: 'Colossians', osisAbbrev: 'cl', chapters: [29, 23, 25, 18] as const },
  { displayName: '1 Thessalonians', osisAbbrev: '1ts', chapters: [10, 20, 13, 18, 28] as const },
  { displayName: '2 Thessalonians', osisAbbrev: '2ts', chapters: [12, 17, 18] as const },
  { displayName: '1 Timothy', osisAbbrev: '1tm', chapters: [20, 15, 16, 16, 25, 21] as const },
  { displayName: '2 Timothy', osisAbbrev: '2tm', chapters: [18, 26, 17, 22] as const },
  { displayName: 'Titus', osisAbbrev: 'tt', chapters: [16, 15, 15] as const },
  { displayName: 'Philemon', osisAbbrev: 'phm', chapters: [25] as const },
  {
    displayName: 'Hebrews',
    osisAbbrev: 'hb',
    chapters: [14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25] as const,
  },
  { displayName: 'James', osisAbbrev: 'jm', chapters: [27, 26, 18, 17, 20] as const },
  { displayName: '1 Peter', osisAbbrev: '1pe', chapters: [25, 25, 22, 19, 14] as const },
  { displayName: '2 Peter', osisAbbrev: '2pe', chapters: [21, 22, 18] as const },
  { displayName: '1 John', osisAbbrev: '1jo', chapters: [10, 29, 24, 21, 21] as const },
  { displayName: '2 John', osisAbbrev: '2jo', chapters: [13] as const },
  { displayName: '3 John', osisAbbrev: '3jo', chapters: [15] as const },
  { displayName: 'Jude', osisAbbrev: 'jd', chapters: [25] as const },
  {
...
/** Maximum number of scripture references allowed in SA `bibleText`. */
export const SERMON_AUDIO_MAX_BIBLE_REFERENCES = 2;
